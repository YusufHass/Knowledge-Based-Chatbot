...
system_prompt = (
    ...
    "When giving a numbered list, state the source at the bottom of each paragraph"
    "Get rid of all dollar signs from the answer and replace it with the word dollars"
    "Take all of the chapters used and cite them at the end. This is very important, you must state the source"
